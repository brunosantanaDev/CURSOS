let pizzaJson = [
    ...
    {id:8, name:'Portuguesa', img:'images/pizza4.png', price:25.00, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'}
];
