...
const my3FavoriteTVShows = ["suits","fringe","o mentalista"]
const text = my3FavoriteTVShows.join(", ").replace(", l"," e l")
const sentence = `Minhas 3 séries favoritas são: ${text}.`
...
var verdad = (my3FavoriteTVShows.length == 3)
//console.log(verdad)
